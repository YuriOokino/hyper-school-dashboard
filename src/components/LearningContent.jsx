...
export default function LearningContent({ masteryData, getColorClasses, showMasteryOnly = false, onLessonClick }) {
  ...
  const lifeSkillsData = [
    { subject: 'Communication', lesson: 'Public Speaking and Presentation Skills', credits: '120/150', mastery: 80, progress: 80, time: '3h30m', masteryColor: 'blue' },
    { subject: 'Leadership', lesson: 'Team Management and Decision Making', credits: '90/120', mastery: 75, progress: 75, time: '2h45m', masteryColor: 'green' },
    { subject: 'Financial Literacy', lesson: 'Budgeting and Personal Finance', credits: '150/180', mastery: 83, progress: 83, time: '4h15m', masteryColor: 'green' },
    { subject: 'Time Management', lesson: 'Productivity and Goal Setting', credits: '75/100', mastery: 75, progress: 75, time: '2h20m', masteryColor: 'blue' },
    { subject: 'Problem Solving', lesson: 'Critical Thinking and Analysis', credits: '110/140', mastery: 79, progress: 79, time: '3h10m', masteryColor: 'green' },
    { subject: 'Emotional Intelligence', lesson: 'Self-Awareness and Empathy', credits: '95/120', mastery: 79, progress: 79, time: '2h50m', masteryColor: 'blue' },
    { subject: 'Digital Literacy', lesson: 'Online Safety and Digital Citizenship', credits: '85/110', mastery: 77, progress: 77, time: '2h35m', masteryColor: 'green' },
    { subject: 'Health & Wellness', lesson: 'Mental Health and Stress Management', credits: '100/130', mastery: 77, progress: 77, time: '3h00m', masteryColor: 'blue' },
    { subject: 'Career Planning', lesson: 'Resume Writing and Interview Skills', credits: '130/160', mastery: 81, progress: 81, time: '3h45m', masteryColor: 'green' },
    { subject: 'Civic Engagement', lesson: 'Community Service and Social Responsibility', credits: '70/90', mastery: 78, progress: 78, time: '2h10m', masteryColor: 'blue' }
  ];

  // Vocational Skills data array
  const vocationalSkillsData = [
    { subject: 'Carpentry', lesson: 'Basic Woodworking and Tool Safety', credits: '140/180', mastery: 78, progress: 78, time: '4h20m', masteryColor: 'green' },
    { subject: 'Culinary Arts', lesson: 'Kitchen Fundamentals and Food Safety', credits: '160/200', mastery: 80, progress: 80, time: '5h30m', masteryColor: 'green' },
    { subject: 'Automotive', lesson: 'Engine Maintenance and Basic Repairs', credits: '120/150', mastery: 80, progress: 80, time: '4h00m', masteryColor: 'blue' },
    { subject: 'Electronics', lesson: 'Circuit Design and Troubleshooting', credits: '110/140', mastery: 79, progress: 79, time: '3h45m', masteryColor: 'green' },
    { subject: 'Healthcare', lesson: 'First Aid and Medical Terminology', credits: '130/160', mastery: 81, progress: 81, time: '4h15m', masteryColor: 'green' },
    { subject: 'Cosmetology', lesson: 'Hair Styling and Skin Care Basics', credits: '100/130', mastery: 77, progress: 77, time: '3h20m', masteryColor: 'blue' },
    { subject: 'Welding', lesson: 'Metal Fabrication and Safety Protocols', credits: '150/180', mastery: 83, progress: 83, time: '5h00m', masteryColor: 'green' },
    { subject: 'Plumbing', lesson: 'Pipe Installation and Repair Techniques', credits: '90/120', mastery: 75, progress: 75, time: '3h00m', masteryColor: 'blue' },
    { subject: 'Electrical', lesson: 'Wiring and Electrical Safety', credits: '120/150', mastery: 80, progress: 80, time: '4h00m', masteryColor: 'green' },
    { subject: 'HVAC', lesson: 'Heating and Cooling System Basics', credits: '110/140', mastery: 79, progress: 79, time: '3h30m', masteryColor: 'blue' }
  ];

  // Get current data based on active tab
  const getCurrentData = () => {
    if (activeTab === 'classes') return classesData;
    if (activeTab === 'life-skills') return [...lifeSkillsData, ...vocationalSkillsData];
    return classesData;
  };
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left py-3 px-4 font-semibold text-base">Mastery Score</th>
          ...
          <tbody>
            {currentLessons.map((lesson, index) => (
              <tr key={index} className="border-b border-gray-100 hover:bg-gray-50 cursor-pointer" onClick={onLessonClick}>
                ...
                <td className="py-3 px-4">
                  <button className="flex items-center space-x-1 text-blue-600 text-base">
                    <span>Continue</span>
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
