    ...
    <div className="space-y-4">
      ...
      <div className="bg-white p-6">
        ...
        <div className="grid grid-cols-3 gap-2">
          <button className="bg-gray-100 p-2 text-xs hover:bg-gray-200 rounded font-medium text-center">Start Lesson</button>
          <button className="bg-gray-100 p-2 text-xs hover:bg-gray-200 rounded font-medium text-center">Learn a Skill</button>
          <button className="bg-gray-100 p-2 text-xs hover:bg-gray-200 rounded font-medium text-center">Review a Topic</button>
        </div>
      </div>
